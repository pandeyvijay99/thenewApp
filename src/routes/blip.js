...
const { fetchBlip, uploadProfilePic, uploadBlipFile, fetchAllBlip, postReaction, postRating, totalReaction, totalRating, fetchGroupRating, blipView, trendingViews, believersBlip, getUserBlipBasedOnWebname, updateContent } = require("../controller/blip");
...
router.route("/getUserBlipBasedOnWebname").post( getUserBlipBasedOnWebname)
